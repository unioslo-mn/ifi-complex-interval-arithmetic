...
text(real(A.Center),imag(A.Center), '$A^I_m$',...
...
annotation('textbox',[.133,.304,.12,.20],'String',annotText, ...
           'FontSize',fontSizeM,...
           'BackgroundColor','w',...
...
text(real(Ac(2).Center),imag(Ac(2).Center),'$A^I_2$', ...
    'HorizontalAlignment', 'center','Interpreter','latex')
text(real(Bc.Center),imag(Bc.Center)+0.15,'$B^I=$', ...
    'HorizontalAlignment', 'center','Interpreter','latex')
text(real(Bc.Center),imag(Bc.Center)-0.15,'$E^I_1 A^I_1+E^I_2 A^I_2$', ...
    'HorizontalAlignment', 'center','Interpreter','latex')
...
annotation('textbox',[.765,.70,.13,.21],'String',annotText, ...
           'HorizontalAlignment','right', ...
           'Interpreter','latex');
