...
%% Exponential function on a random rectangular interval
...
title('Mapping of exponential function');
xlabel('Real');
ylabel('Imaginary');
axis equal;


%% Exponential function on a random polar interval
...
% Plot the sqrtuared points
subplot(1, 2, 2);
scatter(real(sqrtuaredPoints), imag(sqrtuaredPoints), 5, 'filled');
hold on;

exp_p1.plot('k', 'LineWidth', 1);
